...
module.exports = function(docName, schema) {
   ...
   * - operator <String> operador para realizar la actualizacion
   * - data <Object> criteria de actualizacion
   * - options <Object> opciones de actualizacion
   * returns: <Promise>
   */
  this.pFindAndModify =
    function pFindAndModify(query, operator, data, options) {
      var promise;
      //
   ...
   */
  this.pUpdate =
    function pUpdate(query, operator, data, options) {
      var promise;
      //
      query = typeof query === 'undefined' ? {} : query;
      //
